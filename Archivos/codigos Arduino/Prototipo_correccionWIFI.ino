...
void corregirErrorWifi(){
  if (Serial.available() > 0) {
      byteAnterior = incomingByte;
      incomingByte = Serial.read();
      Serial.println(incomingByte);
      Serial.println("byte Anterior:");
      Serial.println(byteAnterior);
      //esp-wifi-a
      if(incomingByte == 49 && byteAnterior == 49){
        lcd.setCursor(0, 1);
        lcd.print("                ");
        lcd.setCursor(0, 1);
      ...
      //esp-wifi-b
      if(incomingByte == 50 && byteAnterior == 50){
        lcd.setCursor(0, 1);
        lcd.print("                ");
        lcd.setCursor(0, 1);
      ...
      //esp-wifi-c
      if(incomingByte == 51 && byteAnterior == 51){
        lcd.setCursor(0, 1);
        lcd.print("                ");
        lcd.setCursor(0, 1);
      ...
      if(incomingByte == 120 && byteAnterior == 120){
        lcd.setCursor(0, 1);
        lcd.print("                ");
        lcd.setCursor(0, 1);
        lcd.print("Optishop");
